describe('ZinZen-page Test', () => {
  ...
  it('Should have donate btn', () => {
    cy.contains('Donate').parent().should('have.attr', 'href', 'https://www.gofundme.com/f/deliver-purpose-with-an-app-for-keeping-promises/donate');
  });

  it('Should have Feedback btn that redirects to feedback page', () => {
    cy.contains('Feedback').parent().click().location('pathname')
