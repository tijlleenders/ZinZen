...
const MobileHeader = () => {
    ...
    return (react_1.default.createElement(react_bootstrap_1.Navbar, { collapseOnSelect: true, expand: "lg" },
        react_1.default.createElement("img", { role: "presentation", src: zinzenlogo_png_1.default, alt: "Text Nav", className: "zinzen-logo-nav-landing-page", onClick: () => {
                navigate("/");
            } }),
        react_1.default.createElement("img", { src: LogoTextLight_svg_1.default, alt: "Logo Nav", className: "zinzen-text-logo-nav-landing-page" })));
};
