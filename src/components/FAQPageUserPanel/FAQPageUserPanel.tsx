  ...
  return (
    <div className="slide">
      <Container fluid>
        <Row>
          <h3
            className={darkModeStatus ? 'faq-question-text-dark' : 'faq-question-text-light'}
          >
            {t('Qwhatiszinzen')}
          </h3>
          <p
            className={darkModeStatus ? 'faq-answer-text-dark' : 'faq-answer-text-light'}
          >
            {t('AnsWhatiszinzen')}
          </p>
        </Row>
