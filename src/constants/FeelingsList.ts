...
export const feelingsList = {
  ...
  gratitude: ['harmony', 'thankful', 'triumphed', 'worthy', 'satisfied', 'awed'],
  sad: ['sad', 'lonely', 'gloomy', 'disappointed', 'miserable', 'hopeless'],
  afraid: ['worried', 'doubtful', 'nervous', 'anxious', 'panicked', 'stressed'],
  angry: ['annoyed', 'frustrated', 'bitter', 'infuriated', 'mad', 'insulted'],
};
