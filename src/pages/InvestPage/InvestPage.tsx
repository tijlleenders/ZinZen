  ...
  return (
    <div className="slide" style={{ display: "flex", justifyContent: "center" }}>
      <div id="invest-container">
        ...
        <p>
          The app is free for people.

        </p>
        <p>
          We <span>charge companies</span> to publish company goals
          and get honest real-time feedback from passionate employees with balanced lives.
        </p>
        <p>
          In a few months, with four people, part-time and fully remote,
        </p>
        <p> <span>we built an MVP, </span></p>
        <p> <span>got media attention,  </span></p>
        <p> <span>and a big launching customer.  </span></p>

        <p>In the battle with big tech - we will win. We&apos;ve designed for it.  </p>
        <p><span>A platform like ZinZen requires trust,</span></p>
        <p>trust that best comes from an open, not-for-profit, privacy-friendly team.  </p>

        <p>What open source has done for software, </p>
        <p>ZinZen will do for <span> human purpose. </span> </p>
