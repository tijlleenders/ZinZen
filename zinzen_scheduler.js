...
/**
*/
__exports.starts_as_soon_as_module_is_loaded = function() {
    wasm.starts_as_soon_as_module_is_loaded();
};
...
* @returns {any}
*/
__exports.load_calendar = function(val) {
    try {
        var ret = wasm.load_calendar(addBorrowedObject(val));
